        ...
        <aside className="flex flex-col w-64 bg-red-600 text-white min-h-screen justify-between fixed left-0 top-0 z-20">
          <div>
            ...
            <nav className="flex flex-col gap-2 mt-8 px-6">
              ...
              <Link
                href="/admin/reports"
                className="py-2 px-3 rounded-md text-lg font-medium bg-white/10 flex items-center gap-2"
              >
          ...
          <div className="bg-white rounded-2xl border p-6 shadow-sm">
            ...
            <div className="flex flex-col gap-4">
              {filteredReports.map((report) => (
                <div
                  key={report.id}
                  className="rounded-2xl border border-gray-300 p-6 bg-white flex flex-col md:flex-row md:items-center md:justify-between gap-2 shadow-sm hover:shadow-md transition-shadow"
                >
                  <div className="flex flex-col gap-2 flex-1">
                    ...
                    {report.status === "pending" && (
                      <div className="flex gap-2 mt-2">
                        <button
                          className="flex items-center gap-2 px-6 py-2 rounded-lg border border-green-600 text-green-600 font-medium bg-white hover:bg-green-50 transition-colors text-base"
                          onClick={() => setReports(
                            reports.map((r) =>
                        ...
                        <button
                          className="flex items-center gap-2 px-6 py-2 rounded-lg border border-red-600 text-red-600 font-medium bg-white hover:bg-red-50 transition-colors text-base"
                          onClick={() => setReports(
                            reports.map((r) =>
