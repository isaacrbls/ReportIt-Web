      ...
      <aside className="flex flex-col w-64 bg-red-600 text-white min-h-screen justify-between fixed left-0 top-0 z-20">
        <div>
          ...
          <nav className="flex flex-col gap-2 mt-8 px-6">
            <Link href="/admin" className="py-2 px-3 rounded-md text-lg font-medium hover:bg-white/10 transition-colors">
              Dashboard
            </Link>
            <Link href="/admin/analytics" className="py-2 px-3 rounded-md text-lg font-medium bg-white/10">
              Analytics
            </Link>
            <Link href="/admin/reports" className="py-2 px-3 rounded-md text-lg font-medium hover:bg-white/10 transition-colors">
              Manage Reports
            </Link>
          </nav>
        </div>
