...
export function EditCategoryDialog({ open, onOpenChange, category, onSave }) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg rounded-2xl">
        <DialogHeader>
          <DialogTitle className="text-3xl font-bold text-red-600">Edit Category</DialogTitle>
          <DialogDescription className="text-gray-400">
            Edit category details and keywords for machine learning categorization
          </DialogDescription>
        </DialogHeader>
        <div className="mt-6">
